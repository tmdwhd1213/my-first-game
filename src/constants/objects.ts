...
export const platforms = [
  new Platform(0, 300, 400, 20),
  new Platform(450, 200, 100, 20),
  new Platform(600, 150, 150, 20),
  new Platform(800, 150, 150, 20),
  new Platform(1000, 150, 150, 20),
  new Platform(1200, 250, 200, 20),
  new Platform(1500, 250, 200, 20),
  new Platform(1700, 300, 200, 20),
  new Platform(1950, 250, 200, 20),
]

export const monsters = [
  new Monster(300, 220, 30, 30),
  new Monster(500, 170, 30, 30),
]
